...
namespace OpenSMOKE
{
        ...
        class ICSystem_CVODE_Template : public OpenSMOKE::OpenSMOKE_OdeSystemObject
        {
            DEFINE_ODESOLVERINTERFACE_CVODE_Sundials(ICSystem_CVODE_Template)
        ...
        public:
            ...
            void SetOdeSystem(ASALI::ICSystem* ode)
            {
                ode_ = ode;
