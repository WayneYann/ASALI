...
void BVPSystem::setFeedTemperature(const double Tin)
{
    Tin_ = Tin;
}

void BVPSystem::setMassFraction(const std::vector<double> IN)
{
...
void BVPSystem::setCoolantTemperature(const double Tw)
{
    Tw_ = Tw;
}
...
void BVPSystem::setGasProperties(const double cpG,
                                 const double kG,
                                 const double mu,
                                 const double diff)
{
...
void BVPSystem::setGrid(const unsigned int Na, const unsigned int Nr)
{
    Na_ = Na;
    Nr_ = Nr;
}

void BVPSystem::setReactionType(const std::string reactionType)
{
    reactionType_ = reactionType;
}

void BVPSystem::setPackedBed(const double Dt, const double Dp, const double L)
{
    double NP = Dt/Dp;
...
void BVPSystem::setHoneyComb(const double Dt,
                             const double CPSI,
                             const double w,
                             const double Sw,
                             const double L,
...
void BVPSystem::setMicroBed(const double Dt,
                            const double CPSI,
                            const double Dp,
                            const double w,
                            const double L)
...
void BVPSystem::resize(const std::string type)
{
    reactorType_ = type;
    iteration    = 0.;
...
void BVPSystem::AlgebraicEquations(BzzVectorInt& M)
{
...
void BVPSystem::AlgebraicEquations(OpenSMOKE::OpenSMOKEVectorBool& M)
{
    ChangeDimensions(NE_, &M, true);
    unsigned int counter = 1;
    if ( reactorType_ == "honeyComb" )
...
void BVPSystem::start(const std::string type)
{
    std::cout << "\n######################################" << std::endl;
...
void BVPSystem::end(const std::string type)
{
    delete [] omegaWall_;
    delete [] omegaBulk_;
